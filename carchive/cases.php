...
$sql="select * from cases where priority='0' and cachive_id='".$_SESSION['CARCHIVE_ID']."' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['court']==''){ ?>
                            <a href="manage_court.php?id=<?php echo $row['id']?>"><label class="btn btn-success mr-2 hand_cursor">Add Appointment</label></a>
                        <?php }else{ ?>
                            <?php if($row['judge_id']=='0'){ ?>
                                <a href="manage_court.php?id=<?php echo $row['id']?>"><label class="btn btn-secondary mr-2 hand_cursor">Edit Appointment</label></a>&nbsp;
                            <?php }else{ ?>
