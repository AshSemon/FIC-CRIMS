...
$sql="select * from cases where priority='1' and cachive_id='".$_SESSION['CARCHIVE_ID']."' order by id desc";
                    ...
                    <div class = "item-detail">
                        ...
                        <div class = "item-price">
                            <span class = "new-price">
                                ...
                                <?php } } else { ?>
                                <span href = "#" class = "item-name">Appointment :  NOT Appointed Yet!!</span>
                                <?php } ?>
                            </span>
                        </div>
                        ...
                        <?php if($row['court']==''){ ?>
                            <a href="manage_special.php?id=<?php echo $row['id']?>"><label class="btn btn-success mr-2 hand_cursor">Add Appointment</label></a>
                        <?php }else{ ?>
                            <?php if($row['judge_id']=='0'){ ?>
                                <a href="manage_special.php?id=<?php echo $row['id']?>"><label class="btn btn-secondary mr-2 hand_cursor">Edit Appointment</label></a>&nbsp;
                            <?php }else{ ?>
