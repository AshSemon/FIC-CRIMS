...
if(isset($_POST['submit'])){
  ...
  if($id==''){
		$sql="select * from court_returned where caseid='$caseid' ";
	}else{
		$sql="select * from court_returned where caseid='$caseid' and id!='$id'";
	}
  if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		$msg="Case already court_returned";	
	}else{
    mysqli_query($con,"insert into court_returned(rejection,caseid,priority,casetype,accuser,agender,adob,aaddress,aphone,awork,pstatement,defendent,dgender,ddob,dmother,dfather,dwork,dfamily,daddress,dphone,dstatement,cine,accusation,imprisioned,arn,investigated,prosecutor,judge,witness,statement,invest_statement,pro_statement,status,added_on) values('$rejection','$caseid','$priority','$casetype','$accuser','$agender','$adob','$aaddress','$aphone','$awork','$pstatement','$defendent','$dgender','$ddob','$dmother','$dfather','$dwork','$dfamily','$daddress','$dphone','$dstatement','$cine','$accusation','$imprisioned','$arn','$detective','$prosecuter','$judge','$witness','$statement','$invest_statement','$pro_statement',1,'$added_on')");
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <span class="nav-profile-name"><?php echo $_SESSION['AJ_USER_NAME']?></span>
            </a>
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="accordion">
                      <div class="form-group">
                          <label for="exampleInputName1"><b>Rejection Statement</b> </label>
                          <textarea class="form-control" placeholder="Please enter Rejection Statement" name="rejection" id="" cols="20" rows="6"></textarea>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="content">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <textarea readonly class="form-control" placeholder="Plaintiff's statement" name="pstatement" id="" cols="30" rows="10" required ><?php echo $courtRow['pstatement']?></textarea>
                            </div>
                        ...
                        <div class="content">
                          <br>
                            ...
                            <div class="form-group">
                              ...
                              <textarea readonly class="form-control" placeholder="Defendent's statement" name="dstatement" id="" cols="30" rows="10"><?php echo $courtRow['dstatement']?></textarea>
                            </div>
                        </div>
                      </div>
                                    <!--- 3 --->
                      <div class="contentBx">
                        ...
                        <br>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Prosecuter Name" name="prosecuter" required value="<?php echo $courtRow['prosecutor']?>" readonly>
                          </div>

                          <div class="form-group">
                            <label for="exampleInputName1">Judge :</label>
                            <input type="text" class="form-control" placeholder="Judge Name" name="judge" required value="<?php echo $_SESSION['AJ_USER_NAME']?>" readonly>
                          </div>
                          ...
                          <div class="form-group" id="dish_box1">
                            ...
                            <div class="form-group">
                              ...
                              <textarea readonly class="form-control" placeholder="INVERSTIGATION statement" name="invest_statement" id="" cols="30" rows="10"><?php echo $courtRow['invest_statement']?></textarea>
                            </div>

                            <div class="form-group">
                              <label for="exampleInputName1">Prosecution statement</label>
                              <textarea readonly class="form-control" placeholder="Prosecution statement" name="pro_statement" id="" cols="30" rows="10"><?php echo $courtRow['pro_statement']?></textarea>
                            </div>
