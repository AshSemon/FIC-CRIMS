...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['carchive'])){
    ...
    mysqli_query($con,"update cases set cachive_id='$carchive' where id='$id'");
    redirect(SITE_PATH.'assistant/case_details.php?id='.$id);
  }
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div>
                  ...
                  <?php }else{?>
                    ...
                    <div>
                        <?php
                            echo "<h4>Assign to Archive :- ".getArchiveById($courtRow['cachive_id'])."</h4>"
                        ?>
              ...
              <script>
                function updatecarchiveAssign(){
                  ...
                  if(carchive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>assistant/case_details.php?id='+oid+'&carchive='+carchive;
                  }
                }
