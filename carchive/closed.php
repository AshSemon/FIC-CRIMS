...
$sql="select * from cases where status='0' and cachive='".$_SESSION['CARCHIVE_ID']."' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['sended']=='0'){ ?>
                            <a href="case_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Share Decision</label></a>
                        <?php }else{ ?>
