...
if(isset($_POST['submit'])){
    ...
    $sql="select * from cuser where username='$username' and password='$password' and role_id='9' and status=1";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['JUDGE_IS_LOGIN']='yes';
      $_SESSION['JUDGE_USER']=$row['name'];
      $_SESSION['JUDGE_USER_NAME']=$row['username'];
