...
if(isset($_POST['submit'])){
    ...
    $sql="select * from cuser where username='$username' and password='$password' and role_id='8' and status=1";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['CARCHIVE_IS_LOGIN']='yes';
      $_SESSION['CARCHIVE_USER']=$row['name'];
      $_SESSION['CARCHIVE_USER_NAME']=$row['username'];
      $_SESSION['CARCHIVE_ID']=$row['id'];
      redirect('index.php');
    }else{
