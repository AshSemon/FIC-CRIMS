...
<div class="main-panel">
    ...
    <div class="card">
    <div class="card-body">
      <h1 class="grid_title" style="text-align:center;">Wolaita Sodo First Instance Court Work Roles</h1>
			<a href="manage_role.php" class="btn"><div style="text-align:center;">Add Work Roles</div> </a><br><br>
