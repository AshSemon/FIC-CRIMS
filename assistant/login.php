...
if(isset($_POST['submit'])){
    ...
    $sql="select * from cuser where username='$username' and password='$password' and role_id='7' and status=1";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['AJ_IS_LOGIN']='yes';
      $_SESSION['AJ_USER']=$row['name'];
      $_SESSION['AJ_USER_NAME']=$row['username'];
      $_SESSION['AJ_ID']=$row['id'];
      redirect('index.php');
    }else{
