        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <span href = "#" class = "item-name">Assigned by :  <?php echo $row['jachive']?></span>
                        ...
                        <?php
                        echo "<h5>Assign to Archive :- ".getArchiveById($row['cachive_id'])."</h5>"
                        ?>
                        <?php if($row['cachive_id']=='0'){ ?>
                            <?php if($row['returned']=='0'){ ?>
                                <a href="special_return.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to WSJD</label></a>
                            <?php }else{ ?>
