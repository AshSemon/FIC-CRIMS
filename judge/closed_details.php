            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="main-carousel">
                  ...
                  <!--Fourth cell Prosecutor-->
                  <?php if($courtRow['hearing']=='0') {?>

                  <?php }else{?>
                  <div class="cell">
                    <div class="card-body">
                      <div class="container-fluid">
                      <h4 class="text-middle">COURT HEARING</h4>
                        <h3 class="text-right my-3">Court Case&nbsp;&nbsp;#<?php echo $courtRow['id']?></h3>
                      ...
                      <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                        <div class="table-responsive w-100">
                          <?php 
                            $hearing_res=mysqli_query($con,"select * from hearing where cases_id='".$courtRow['id']."' order by id asc");
                          ?>
                          <p>
                            <?php
                            while($hearing_row=mysqli_fetch_assoc($hearing_res)) {
                            ?>
                              <?php
                              echo "<h6>Judge :- ".getJudgeById($courtRow['judge_id'])."</h6>"
                              ?>
                              <p><?php echo $hearing_row['hearing'];?></p>
                            <?php } ?>
                          </p><br>
                        </div>
                      </div>
                ...
                <div class="cell">
                  <div class="card-body">
                    ...
                    <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                      <div class="table-responsive w-100">
                        <?php 
                          $conclution_res=mysqli_query($con,"select * from conclution where cases_id='".$courtRow['id']."' order by id asc");
                        ?>
                        <p>
                          <?php
                          ...
                          ?>
                            ...
                            echo "<h6>Judge :- ".getJudgeById($courtRow['judge_id'])."</h6>"
                            ?>
                            <p><?php echo $conclution_row['conclution'];?></p>
                          <?php } ?>
                        </p><br>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <?php
                      $archiveAssignRes=mysqli_query($con,"select * from cuser where role_id='8' and status=1 order by id asc");
                  ?>
                  <div>
                      <?php
                          echo "<h4>Assign to Archive :- ".getArchiveById($courtRow['cachive'])."</h4>"
                      ?>
                      <select name="carchive" id="carchive" class="form-control w200" onclick="updatecarchiveAssign()">
