...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
	...
	if($type=='delete'){
		mysqli_query($con,"delete from cuser where id='$id'");
		redirect('staf.php');
	}
	if($type=='active' || $type=='deactive'){
		...
		mysqli_query($con,"update cuser set status='$status' where id='$id'");
		redirect('staf.php');
	}

}
$sql="select cuser.*,role.role from cuser,role where cuser.role_id=role.id order by cuser.id desc";
...
<div class="main-panel">
    ...
    <div class="card">
    <div class="card-body">
      <h1 class="grid_title" style="text-align:center;">Wolaita Sodo First Instance Court Staff</h1>
