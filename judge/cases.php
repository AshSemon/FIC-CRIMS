...
$sql="select * from cases where priority='0' and status='1' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['take']=='0'){ ?>
                            <a href="?id=<?php echo $row['id']?>&type=take"><label class="btn btn-success mr-2 hand_cursor">Take</label></a>
                        <?php }else{ ?>
                            <a href="javascript:void(0)"><label class="btn btn-secondary mr-2 hand_cursor">Taken</label></a>
                        <?php } ?>
